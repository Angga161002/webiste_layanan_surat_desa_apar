    ...
    <div class="container">
        ...
        <div class="content">
            <p style="text-align: center; font-weight: bold; text-decoration: underline; margin-bottom: -14px">
                @if ($pengajuans->id_jenis_surat == 5)
            ...
            <br>
            <p>Sesuai dengan nama yang bersangkutan diatas, surat keterangan/pengantar ini dibuat untuk  keperluan {{ ucfirst($pengajuans->keterangan) }}.</p>
