    ...
    <div class="container">
        ...
        <div class="content">
            <p style="text-align: center; font-weight: bold; text-decoration: underline; margin-bottom: -14px">
                @if ($pengajuans->id_jenis_surat == 6)
            ...
            <table class="table" style="margin-left: 40px">
                ...
                <tr>
                    <td>NIK</td>
                    <td>:</td>
                    <td><b>{{ ucfirst($pengajuans->nik_penduduk) }}</b></td>
                </tr>
                <tr>
            ...
            <br>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Menerangkan bahwa nama yang tersebut di atas
                adalah warga Desa Apar dan menurut pendataan kami tidak pernah terlihat kriminal, tidak pernah terlibat
                Narkoba dan tidak pernah dihukum atau dipenjara karna kejahatan.</p>
