...
<head>
    ...
    <title>Surat Pernyataan Belum / Tidak Bekerja</title>
    <style>
    ...
    <div class="container">
        ...
        <div class="content">
            <p style="text-align: center; font-weight: bold; text-decoration: underline; margin-bottom: -14px">
                @if ($pengajuans->id_jenis_surat == 9)
            ...
            <table class="table" style="margin-left: 40px">
                ...
                <tr>
                    <td>NIK</td>
                    <td>:</td>
                    <td>{{ ucfirst($pengajuans->nik_penduduk) }}</td>
                </tr>
                <tr>
            ...
            <br>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nama yang tertera di atas sepanjang pengetahuan kami benar-benar belum / tidak bekerja.</p>
