    ...
    <div class="container">
        ...
        <div class="content">
            <p style="text-align: center; font-weight: bold; text-decoration: underline; margin-bottom: -14px">
                @if ($pengajuans->id_jenis_surat == 4)
            ...
            <br>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nama yang tersebut di atas adalah benar Penduduk Desa Apar Kec. Pariaman Utara Kota Pariaman memiliki usaha {{ ucfirst($pengajuans->jenis_usaha) }} berlokasi di Kota Pariaman .</p>
