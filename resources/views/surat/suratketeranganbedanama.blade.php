    ...
    <div class="container">
        ...
        <div class="content">
            <p style="text-align: center; font-weight: bold; text-decoration: underline; margin-bottom: -14px">
                @if ($pengajuans->id_jenis_surat == 8)
            ...
            <br>
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Menurut sepengetahuan kami nama yang bersangkutan diatas adalah orang yang sama dan yang sebenarnya bernama {{ ucfirst($pengajuans->keterangan) }} sesuai dengan yang tertera di KK dan KTP .</p>
