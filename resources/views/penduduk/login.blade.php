            ...
            <div class="row mx-0">
                <div class="d-flex hero-static col-md-6 col-xl-4 align-items-center bg-default-grey invisible px-0"
                    ...
                    <div class="content content-full content-login" style="height: auto">
                        ...
                        <form class="js-validation-signin signIn" action="{{ route('penduduk.authenticate') }}" method="post">
                            ...
                            <div class="form-group row">
                                <div class="custom-control custom-checkbox" style="margin-left: 11px">
                                    <span class="label-remember" for="Register" style="margin-left: -18px;">Belum Punya Akun? <a href="{{ route('penduduk.register') }}">Register Disini!!</a></span><br><br>
