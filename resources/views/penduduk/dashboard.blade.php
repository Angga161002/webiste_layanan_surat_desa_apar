            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Dashboard Penduduk</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-lg-4 col-6">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="{{ route('penduduk.tambahpengajuan') }}" class="small-box-footer">Ajukan Surat <i
                ...
                <div class="col-lg-4 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3 style="overflow-wrap: break-word;">Surat Keterangan</h3>
                            <p>Tidak Mampu</p>
                        </div>
